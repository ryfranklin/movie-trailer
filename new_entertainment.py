...
#Instance variable.  Brings up information for the movie "Inception" when run through the constructor.
inception = media.Movie("Inception",     #Title
                        "Dom Cobb (Leonardo DiCaprio) is a thief with the rare ability to enter people's dreams and steal their secrets from their subconscious. His skill has made him a hot commodity in the world of corporate espionage but has also cost him everything he loves. Cobb gets a chance at redemption when he is offered a seemingly impossible task: Plant an idea in someone's mind. If he succeeds, it will be the perfect crime, but a dangerous enemy anticipates Cobb's every move.", #Plot Summary
                        "https://upload.wikimedia.org/wikipedia/en/2/2e/Inception_%282010%29_theatrical_poster.jpg", #movie poster URL
                        "https://www.youtube.com/watch?v=YoHD9XEInc0")  #youtube movie trailer url


#Instance variable.  Brings up information for the movie "Iron-Man" when run through the constructor.
...
#Instance variable.  Brings up information for the movie "The Prestige" when run through the constructor.
...
#Instance variable.  Brings up information for the movie "Spirited Away" when run through the constructor.
...
#Instance variable.  Brings up information for the movie "Point Break" when run through the constructor.
...
##Instance variable.  Brings up information for the movie "It Might Get Loud# when run through the constructor.
it_might_get_loud = media.Movie("It Might Get Loud",
                                ...
                                "http://www.gstatic.com/tv/thumb/movieposters/195467/p195467_p_v8_aa.jpg",
                                "https://www.youtube.com/watch?v=ys2LKKfwTjU")


movies = [inception, iron_man, the_prestige, spirited_away, point_break, it_might_get_loud]  #list of movies for the page to open    
